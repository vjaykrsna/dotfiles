...
### Daily Tasks
- [ ] Run system updates: `update-system`
...
- [ ] Check disk usage: `du -sh .[!.]* * | sort -hr`

### Monthly Tasks
- [ ] Full system backup
- [ ] Review and update dotfiles
- [ ] Check for new tools and software
...
- Docker backups: `$HOME/docker-backups/`
- Configuration files: `$HOME/.config/`
- Dotfiles: `$HOME/dotfiles/`
- SSH keys: `$HOME/.ssh/`
- Browser profiles: `$HOME/.mozilla/firefox/` (Firefox)
...
echo "✅ Full backup complete: ${BACKUP_DIR}.tar.gz"
```
...
### System Monitoring
```bash
# Add these aliases for monitoring
alias monitor='btop'
alias disk-usage='dust'
alias processes='procs'
alias network='nethogs'
alias temp='sensors'
...
alias fix-docker='sudo systemctl restart docker'
alias fix-audio='sudo systemctl restart pipewire'
alias fix-bluetooth='sudo systemctl restart bluetooth'
```

### System Cleanup
```bash
alias cleanup-system='sudo apt autoremove -y && sudo apt autoclean && sudo apt clean'
alias cleanup-docker='docker system prune -af --volumes'
alias cleanup-temp='rm -rf /tmp/* ~/.cache/thumbnails/*'
